                ...
                <tr oiid="${oi.id}" class="cartProductItemTR">
                    ...
                    <td>
                        ...
                        <div class="cartProductChangeNumberDiv">
                            ...
                            <input pid="${oi.product.id}" oiid="${oi.id}" class="orderItemNumberSetting" autocomplete="off" value="${oi.num}">
                    ...
                    <td >
							...
							￥<fmt:formatNumber type="number" value="${oi.product.promotePrice*oi.num}" minFractionDigits="2"/>
							</span>
