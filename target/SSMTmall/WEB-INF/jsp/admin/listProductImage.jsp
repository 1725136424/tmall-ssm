            ...
            <td class="addPictureTableTD">
                <div>
                    <div class="panel panel-warning addPictureDiv">
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormSingle"
                                  action="${ pageContext.request.contextPath }/admin_productImage_save" enctype="multipart/form-data">
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <tbody>
                        <c:forEach items="${singleProductImage}" var="pi">
                            <tr>
                                <td>${pi.id}</td>
                                <td>
                                ...
                                <td><a deleteLink="true"
                                       href="${ pageContext.request.contextPath }/admin_productImage_delete?id=${pi.id}"><span
            ...
            <td class="addPictureTableTD">
                <div>
                    ...
                    <div class="panel panel-warning addPictureDiv">
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormDetail"
                                  action="${ pageContext.request.contextPath }/admin_productImage_save"
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <tbody>
                        <c:forEach items="${detailProductImage}" var="pi">
                            <tr>
                                <td>${pi.id}</td>
                                <td>
